...
import { updateContact } from "@/action/contact.action"
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setContacts({
                      ...contacts,
                      socialMedia: { ...contacts.socialMedia, instagram: e.target.value },
                    })
                  }
                  className="border-green-200 focus:border-green-400"
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setContacts({
                      ...contacts,
                      socialMedia: { ...contacts.socialMedia, telegram: e.target.value },
                    })
                  }
                  className="border-green-200 focus:border-green-400"
